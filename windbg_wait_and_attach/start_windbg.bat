REM https://msdn.microsoft.com/en-us/library/windows/hardware/ff561306(v=vs.85).aspx
...
%WINDBG% "C:\Program Files (x86)\Windows Kits\10\Debuggers\x86\windbg.exe" -pn %DEBUGEE% -W %WINDBG_WORKSPACE% -c "$<%%WINDBG_SCRIPT%"
exit